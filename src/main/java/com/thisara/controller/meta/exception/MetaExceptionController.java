package com.thisara.controller.meta.exception;
 ...
 * @since 2021-05-30
 */
@ControllerAdvice("com.thisara.controller.meta")
public class MetaExceptionController extends ExceptionController{

	private static final Logger logger = Logger.getLogger(MetaExceptionController.class.getName());
