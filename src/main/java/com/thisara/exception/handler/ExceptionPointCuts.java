...
public class ExceptionPointCuts {
	...
	@Pointcut("execution(* com.thisara.controller.exception.ExceptionController.handleException(..)) "
			+ "|| execution(* com.thisara.controller.meta.exception.MetaExceptionController.handleException(..))")
	public void exceptionHandller() {}
	
	@Pointcut("execution(* com.thisara.controller.meta.exception.MetaExceptionController.handleException(..))")
